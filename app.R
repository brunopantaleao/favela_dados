  ...
  nav_panel(
    ...
    layout_columns(col_widths = c(4, 4, 4),
     ...
     card(card_body(
        ...
        tags$p("Pantaleão, B. and Montini, I. (2026). Presenting the Favelas Dados dataset, a bird’s-eye view of Brazilian favelas and urban communities. Available at: https://doi.org/10.31235/osf.io/97yb5_v1"
      ))
    ),
    div(
