# Instituto Favelas — Plataforma de Análise
...
i18n <- list(
  pt = list(
    ...
    cite_t  = "Autoria",
    cite_p = "O Favela Dados é um projeto de pesquisa coordenado pelo pesquisador responsável Rodrigo Bonciani (UNIFESP), com os pesquisadores associados Bruno Pantaleão (FGV Analytics), Pierre Moutier (Instituto Favelas), Isabella Montini (UC Berkeley) e Emily Souza (Instituto Favelas). A aplicação e a organização da base de dados foram desenvolvidas por Bruno Pantaleão e Isabella Montini.",   
